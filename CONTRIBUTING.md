...
- `Sources` contains the source code of the project.
	- `CGTUI` contains the C interface for Swift.
	- `Libadwaita` contains the source code of the project.
		- `Adwaita` contains Libadwaita widgets.
		- `GTK` contains GTK widgets.
		- `Swift` contains implementations of some types in Swift.
		- `Extensions` contains extensions of existing Swift types. 
- `Tests` contains an example application for testing `Libadwaita`.
